...
const Footer = () => {
    ...
    return (
        <div className="flex justify-center items-center bg-gray-300 rounded-[20px] py-4 mt-12">
            {isLoading && <Progress />}
            <div>
                <span className="font-epilogue  font-bold text-[20px]  ">Other: </span>
                <span className="font-epilogue text-[20px] truncate">{otherAsset?.title}</span>

                <span className="font-epilogue font-bold text-[20px] ml-20">Own: </span>
                <span className="font-epilogue text-[20px] truncate">{ownAsset?.title}</span>
